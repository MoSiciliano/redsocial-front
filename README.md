...
> **Nota:** Este repositorio contiene únicamente el cliente Frontend. El código de la API (Backend) se encuentra en [Social Network Client](https://github.com/MoSiciliano/redsocial-back)
